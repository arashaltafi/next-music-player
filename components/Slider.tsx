        ...
        setSlides([
            {
                ...
                singer: 'محسن یگانه',
                musicName: 'شروع بهره برداری از پروه‌های برداشت خودکار مالی دربرداری از پروژه‌های برداشت رداشت خودکار مالی دربرداری از پروژه‌های برداشت  خودکار مالی در بانک صادرات ایران' + 1,
            }, {
                id: 2,
                image: 'https://arashaltafi.ir/Social_Media/story-02.jpg',
                singer: 'محسن یگانه',
                musicName: 'شروع بهره برداری از پروژه‌انک صادرات ایران' + 2,
            }, {
                id: 3,
                image: 'https://arashaltafi.ir/Social_Media/story-03.jpg',
                singer: 'محسن یگانه',
                musicName: 'شروع بهره برداری از پروژه‌های برداشت خودکار مالی در بانک صادرات ایران' + 3,
            }
        ])
    }, [])
