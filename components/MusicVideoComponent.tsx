...
const MusicVideoComponent = (props: PropsType) => {
    return (
        ...
        >
            ...
            <Image
                className='cursor-pointer my-3 z-10 w-[calc(100%-64px)] rounded-video hover:rounded-videoHover border border-slate-500 shadow-musicShadow border-solid group-hover:scale-105 group-active:scale-95 group-hover:brightness-125 transition-all duration-300'
                src={props.image}
                alt={props.name}
                width={500}
                height={500}
